...
```
<br>
Ahora tienes que volver a ganar acceso al equipo 1 para ejecuatr el siguiente comando `` socat TCP-LISTEN:<port>,fork TCP:<ip-address>:<port> `` para que todo el tráfico que pase por ese equipo en el puerto indicado sea redirigido a tu máquina de atacante.<br>
